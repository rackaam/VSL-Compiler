...
public class Util {
	...
	/**
	 * Initializes the VSL filename, logger and debugging facilities.
	 * 
	 * @param filename
	 *            name of the VSL file being compiled (used in error messages)
	 * @param debug
	 *            if true, enables output of debugging messages
	 */
